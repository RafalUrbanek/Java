...
public class TheDungeon {
	...
	public static Enemy enemy = new Placeholder();
	...
	final static int START_POTIONS = 3;	// how many health potions the player starts with
	
	// command array index:			 0			1		2		3	      4			5		6(not used)
	static String[] commandList = {"enter", "attack", "flee", "potion", "leave", "take", "inspect"};
	
	// default values
	public static final int DEF_PIC_WIDTH = 480;
	public static final int DEF_PIC_HEIGHT = 505;
	...
	public TheDungeon() {
		...
		pictureWindow.add(mainPicture.getPictureLabel());
